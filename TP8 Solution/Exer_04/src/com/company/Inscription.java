...
public class Inscription extends JFrame {
    ...
    public Inscription() throws HeadlessException {
        ...
        panel4.add(checkBox);
        checkBox = new JCheckBox("Squash");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Natation");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Athlétisme");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Randonnée");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Foot");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Basket");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Volley");
        panel4.add(checkBox);
        checkBox = new JCheckBox("Pelanque");
        panel4.add(checkBox);
